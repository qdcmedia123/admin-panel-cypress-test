        ...
        <Fragment>
          ...
          <div className="page__section">
            <div className="page__section-item">
              <div class="page__section-info-text">
                <h5 class="text-dark text-bold padding-vertical">Users</h5>
                <h5>2213&nbsp; Leads</h5> <div></div>
              </div>
              ...
              {/* if they need search in the right side then put 
                className = "portfolioList rather then account_approve"
              */}
